...
if (Test-Path $logDir) {
    ...
    if ($logFiles.Count -gt 0) {
        ...
        Write-Host " No diagnostic log files found" -ForegroundColor Yellow
    }
}
...
if ($pythonProcesses) {
    ...
    Write-Host " Could not find Python process running main.py" -ForegroundColor Yellow
...
Write-Host "   • [DIAGNOSTIC] Processor Status Check" -ForegroundColor Cyan
Write-Host "   • [DIAGNOSTIC] Quality Validation Parameters" -ForegroundColor Cyan
Write-Host "   • [DIAGNOSTIC] Result type" -ForegroundColor Cyan
Write-Host "   • [QUALITY] Stage: bg_removal" -ForegroundColor Cyan
Write-Host "   • [QUALITY] Stage: shape" -ForegroundColor Cyan
Write-Host "   • [QUALITY] Stage: texture" -ForegroundColor Cyan
Write-Host "   • [AI] Using standard 3D generation" -ForegroundColor Cyan
Write-Host ""
...
if ($runTest -eq "y" -or $runTest -eq "Y") {
    ...
    if ($newLogs) {
        ...
        Write-Host " No new logs captured!" -ForegroundColor Yellow
