...
- June 13, 2025: ü§ó Release [Hunyuan3D-2.1](https://github.com/Tencent-Hunyuan/Hunyuan3D-2.1), fully open-sourced with new PBR model, VAE encoder, and all training code.
...
- Feb 14, 2025:  Release texture enhancement module, please obtain high-definition textures
...
- Jan 27, 2025:  Release Blender addon for Hunyuan3D 2.0, Check it out [here](#blender-addon).
