...
def compute_voxel_grid_mask(position, grid_resolution=8):
    ...
    grid_position_expanded_1 = grid_position.unsqueeze(2).unsqueeze(4)  #  B, N, 1, L, 1, 3
    grid_position_expanded_2 = grid_position.unsqueeze(1).unsqueeze(3)  #  B, 1, N, 1, L, 3

    # 
    distances = torch.norm(grid_position_expanded_1 - grid_position_expanded_2, dim=-1)  #  B, N, N, L, L
